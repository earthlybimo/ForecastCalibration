...
for i in np.arange(4):
    if i==1:
        ...
        plt.plot(np.arange(3*i,3*i+3),IIEE_fcst_yearmonmean_NH[0,3*i:3*i+3],'.-',color='blue',label='L0-2')
        plt.plot(np.arange(3*i,3*i+3),IIEE_fcst_yearmonmean_NH[1,3*i:3*i+3],'.-',color='orange',label='L3-5')
        plt.plot(np.arange(3*i,3*i+3),IIEE_fcst_yearmonmean_NH[2,3*i:3*i+3],'.-',color='green',label='L6-8')
        plt.plot(np.arange(3*i,3*i+3),IIEE_fcst_yearmonmean_NH[3,3*i:3*i+3],'.-',color='red',label='L9-11')
    else:
        plt.plot(np.arange(3*i,3*i+3),IIEE_osisaf_yearmonmean_NH[3*i:3*i+3],'s-k')
        plt.plot(np.arange(3*i,3*i+3),IIEE_fcst_yearmonmean_NH[0,3*i:3*i+3],'.-',color='blue')
        plt.plot(np.arange(3*i,3*i+3),IIEE_fcst_yearmonmean_NH[1,3*i:3*i+3],'.-',color='orange')
        plt.plot(np.arange(3*i,3*i+3),IIEE_fcst_yearmonmean_NH[2,3*i:3*i+3],'.-',color='green')
        plt.plot(np.arange(3*i,3*i+3),IIEE_fcst_yearmonmean_NH[3,3*i:3*i+3],'.-',color='red')
...
for i in np.arange(4):
    if i==1:
        ...
        plt.plot(np.arange(3*i,3*i+3),IIEE_fcst_yearmonmean_SH[0,3*i:3*i+3],'.-',color='blue',label='L0-2')
        plt.plot(np.arange(3*i,3*i+3),IIEE_fcst_yearmonmean_SH[1,3*i:3*i+3],'.-',color='orange',label='L3-5')
        plt.plot(np.arange(3*i,3*i+3),IIEE_fcst_yearmonmean_SH[2,3*i:3*i+3],'.-',color='green',label='L6-8')
        plt.plot(np.arange(3*i,3*i+3),IIEE_fcst_yearmonmean_SH[3,3*i:3*i+3],'.-',color='red',label='L9-11')
    else:
        plt.plot(np.arange(3*i,3*i+3),IIEE_osisaf_yearmonmean_SH[3*i:3*i+3],'s-k')
        plt.plot(np.arange(3*i,3*i+3),IIEE_fcst_yearmonmean_SH[0,3*i:3*i+3],'.-',color='blue')
        plt.plot(np.arange(3*i,3*i+3),IIEE_fcst_yearmonmean_SH[1,3*i:3*i+3],'.-',color='orange')
        plt.plot(np.arange(3*i,3*i+3),IIEE_fcst_yearmonmean_SH[2,3*i:3*i+3],'.-',color='green')
        plt.plot(np.arange(3*i,3*i+3),IIEE_fcst_yearmonmean_SH[3,3*i:3*i+3],'.-',color='red')
#plt.legend()
plt.xticks(np.arange(12),('J', 'F', 'M', 'A', 'M','J', 'J', 'A', 'S', 'O','N','D'),fontsize=12)
plt.ylabel(r'IIEE $(10^6 km^2)$',fontsize=12)
plt.title('Antarctic')
