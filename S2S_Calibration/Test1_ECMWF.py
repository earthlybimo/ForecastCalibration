...
save_path = '/work/ba1138/a270138/BiasCorrOutput/S2S_Results/'
...
targetyear = 2005# targetyear = int(sys.argv[1])
initMonth=5# let's do it so that we calibrate forecasts starting in month 5
